        ...
        <footer className="fixed bottom-0 left-0 right-0 bg-[#050a19]/70 backdrop-blur-lg p-3 z-50 text-neutral-200 text-xs sm:text-sm border-t border-cyan-500/10">
            <div className="max-w-screen-xl mx-auto flex justify-between items-center gap-4 px-4">
                ...
                <div className="flex-grow flex justify-end items-center gap-4 sm:gap-6">
                    <div className="hidden lg:flex items-center gap-2 text-neutral-300 text-right min-w-0">
                    ...
                    <div className="flex flex-row flex-wrap justify-end items-center gap-3 sm:gap-6">
                        <a
                            href="https://jiam.ai"
                            target="_blank"
                            rel="noopener noreferrer"
